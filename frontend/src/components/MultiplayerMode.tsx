    ...
    socketRef.current.on("assignedRoom", (data: any) => {
      ...
      if (startButtonVisible && !gameStarted) {
        ...
        timerIntervalRef.current = window.setInterval(() => {
          const timeLeft =
            15 - Math.floor((Date.now() - timerRef.current) / 1000);
      ...
      {!startButtonVisible && (
        <>
          ...
          >
            ...
            {topic ? (
              <div style={{ position: "inherit", top: "-20px", left: "-10px" }}>
                <span>
                  Draw a{" "}
                  <span
                    style={{
              ...
              <div
                className="loading"
                style={{ position: "inherit", top: "-15px", left: "-10px" }}
              >
